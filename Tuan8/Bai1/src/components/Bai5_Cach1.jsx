          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-10 pr-3 py-2 border rounded focus:outline-none focus:ring-1 focus:ring-blue-500"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-10 pr-10 py-2 border rounded focus:outline-none focus:ring-1 focus:ring-blue-500"
