        ...
        <div className="bg-purple-50 p-6 rounded-lg">
          <div className="flex justify-between items-start mb-6">
            ...
            <button
              ...
              className="bg-purple-500 text-white py-2 px-4 rounded hover:bg-purple-600 flex items-center"
            >
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-10 pr-3 py-2 border rounded focus:outline-none focus:ring-1 focus:ring-purple-500"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-10 pr-10 py-2 border rounded focus:outline-none focus:ring-1 focus:ring-purple-500"
...
export default AuthReduxToolkit;
